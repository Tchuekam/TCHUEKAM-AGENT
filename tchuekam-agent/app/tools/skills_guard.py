...
Trust levels:
  - builtin:   Ships with TchuEkaM. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.tchuekam/\.env|\~/\.tchuekam/\.env',
     "tchuekam_env_access", "critical", "exfiltration",
     "directly references TchuEkaM secrets file"),
    ...
    (r'\.tchuekam/config\.yaml|\.tchuekam/SOUL\.md',
     "tchuekam_config_mod", "critical", "persistence",
     "references TchuEkaM configuration files directly"),
