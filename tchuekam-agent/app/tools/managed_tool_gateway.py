...
def auth_json_path():
    """Return the TchuEkaM auth store path, respecting TCHUEKAM_HOME overrides."""
    return get_tchuekam_home() / "auth.json"
...
def read_nous_access_token() -> Optional[str]:
    ...
    try:
        from tchuekam_cli.auth import resolve_nous_access_token
