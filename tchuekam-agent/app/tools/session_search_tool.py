...
the get_anchored_view / get_messages_around primitives in tchuekam_state.
...
# Third-party integrations tag their sessions with TCHUEKAM_SESSION_SOURCE=tool
...
def check_session_search_requirements() -> bool:
    ...
    try:
        from tchuekam_state import DEFAULT_DB_PATH
