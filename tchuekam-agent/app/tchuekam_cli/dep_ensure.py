...
_DEP_CHECKS = {
    ...
    "browser": lambda: (
        ...
        or _has_tchuekam_agent_browser()
    ),
...
def _has_tchuekam_agent_browser() -> bool:
    ...
    # install.sh installs globally into $TCHUEKAM_HOME/node/bin/ via npm -g --prefix
...
def ensure_dependency(
    ...
    if shell == "powershell":
        ...
        cmd = [
            ...
            "-File", str(script),
            "-Ensure", dep,
            "-TchuEkaMHome", str(get_tchuekam_home()),
        ]
    else:
