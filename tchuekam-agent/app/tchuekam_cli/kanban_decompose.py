...
Invoked by ``tchuekam kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the TchuEkaM Agent board.
...
def _profile_author() -> str:
    """Mirror of ``tchuekam_cli.kanban._profile_author``."""
    return (
