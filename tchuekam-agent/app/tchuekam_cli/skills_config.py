"""
Skills configuration for TchuEkaM Agent.
`tchuekam skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.tchuekam/config.yaml under:
...
from tchuekam_cli.config import cfg_get, load_config, save_config
from tchuekam_cli.colors import Colors, color
from tchuekam_cli.platforms import PLATFORMS as _PLATFORMS
...
def skills_command(args=None):
    """Entry point for `tchuekam skills`."""
    from tchuekam_cli.curses_ui import curses_checklist
