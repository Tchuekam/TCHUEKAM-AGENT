# TchuEkaM Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.tchuekam/plugins/tchuekam-achievements/state.json` (existing unlock state)
  - `~/.tchuekam/plugins/tchuekam-achievements/scan_snapshot.json` (new)
  - `~/.tchuekam/plugins/tchuekam-achievements/scan_checkpoint.json` (new)
