# TchuEkaM Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.tchuekam/plugins/tchuekam-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.tchuekam/plugins/tchuekam-achievements/scan_checkpoint.json`.
