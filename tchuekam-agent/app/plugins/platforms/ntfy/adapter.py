"""ntfy platform adapter (TchuEkaM plugin).
...
a TchuEkaM dependency.

This adapter ships as a TchuEkaM platform plugin under
``plugins/platforms/ntfy/``. The TchuEkaM plugin loader scans the
    ...
    platforms:
      ntfy:
        ...
        extra:
          ...
          topic: "tchuekam-in"              # subscribe topic (incoming)
          publish_topic: "tchuekam-out"     # optional — defaults to topic
...
async def _standalone_send(
    ...
    *,
    ...
    ``tchuekam cron`` running standalone). Without this hook,
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="pip install httpx   # already a TchuEkaM dependency",
