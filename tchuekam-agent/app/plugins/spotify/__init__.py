...
``_check_spotify_available()`` — when the user has not run ``tchuekam auth
spotify``, the tools remain registered (so they appear in ``tchuekam
...
The Spotify auth flow (``tchuekam auth spotify``), CLI plumbing, and docs
