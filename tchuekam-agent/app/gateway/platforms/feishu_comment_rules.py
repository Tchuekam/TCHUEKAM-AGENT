...
Config: ~/.tchuekam/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.tchuekam/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_tchuekam_home()`` helper (TCHUEKAM_HOME-aware and
...
RULES_FILE = get_tchuekam_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_tchuekam_home() / "feishu_comment_pairing.json"
