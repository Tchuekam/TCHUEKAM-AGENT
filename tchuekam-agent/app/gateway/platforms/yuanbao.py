...
try:
    ...
    _TCHUEKAM_VERSION = "0.0.0"

_APP_VERSION = _TCHUEKAM_VERSION
_BOT_VERSION = _TCHUEKAM_VERSION
_YUANBAO_INSTANCE_ID = str(TCHUEKAM_INSTANCE_ID)  # single source: yuanbao_proto.TCHUEKAM_INSTANCE_ID
