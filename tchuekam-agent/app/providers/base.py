...
def _profile_user_agent() -> str:
    """Return a ``tchuekam-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from tchuekam_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"tchuekam-cli/{_ver}"
    except Exception:
        return "tchuekam-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # tchuekam-cli UA so the catalog endpoint is reachable.
