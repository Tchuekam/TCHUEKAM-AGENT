#!/usr/bin/env python3
"""
SWE Runner with TchuEkaM Trajectory Format

A runner that uses TchuEkaM-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the TchuEkaM-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses TchuEkaM-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in TchuEkaM format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches TchuEkaM-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using TchuEkaM-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with TchuEkaM Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses TchuEkaM-Agent's built-in execution environments
    and outputs trajectories in TchuEkaM-Agent format.
    """
    ...
    def _convert_to_tchuekam_format(
        self,
        ...
        """
        Convert internal message format to TchuEkaM trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to TchuEkaM trajectory format
        trajectory = self._convert_to_tchuekam_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with TchuEkaM trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with TchuEkaM Trajectory Format")
    print("=" * 60)
