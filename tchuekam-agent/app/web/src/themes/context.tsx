...
const STORAGE_KEY = "tchuekam-dashboard-theme";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `tchuekam_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "tchuekam-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-tchuekam-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-tchuekam-theme-font", "true");
