          ...
          >
            ...
            >
              ...
              {sidebarNav.pluginItems.length > 0 && (
                <div
                  aria-labelledby="tchuekam-sidebar-plugin-nav-heading"
                ...
                >
                  <span
                    ...
                    id="tchuekam-sidebar-plugin-nav-heading"
                  >
...
function SidebarSystemActions({ onNavigate }: { onNavigate: () => void }) {
  ...
  const items: SystemActionItem[] = [
    ...
    },
    {
      action: "update",
      icon: Download,
      label: t.status.updateTchuEkaM,
      runningLabel: t.status.updatingTchuEkaM,
      spin: false,
    },
  ];
