...
export const tr: Translations = {
  ...
  status: {
    ...
    stopped: "Durduruldu",
    updateTchuEkaM: "TchuEkaM'i Güncelle",
    updatingTchuEkaM: "TchuEkaM güncelleniyor…",
  ...
  pluginsPage: {
    ...
    headline:
      "TchuEkaM eklentilerini keşfedin, yükleyin, etkinleştirin ve güncelleyin (`tchuekam plugins` ile eşdeğer).",
    ...
    removeConfirm: "Bu eklenti ~/.tchuekam/plugins/ içinden kaldırılsın mı?",
    removeHint: "Yalnızca ~/.tchuekam/plugins altındaki kullanıcı tarafından yüklenmiş eklentiler kaldırılabilir.",
  ...
  skills: {
    ...
    filters: "Filtreler",
    noSkills: "Yetenek bulunamadı. Yetenekler ~/.tchuekam/skills/ adresinden yüklenir",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Gerçek oturum geçmişinden kazanılan, koleksiyonluk TchuEkaM rozetleri. Bilinen ama henüz tamamlanmamış başarılar Keşfedildi olarak gösterilir; Gizli başarılar ilk eşleşen davranış görünene kadar saklı kalır.",
      scan_subtitle:
        "TchuEkaM oturum geçmişi taranıyor. Büyük geçmişlerde ilk tarama 5–10 saniye sürebilir.",
    },
    actions: {
      rescan: "Yeniden tara",
    },
    stats: {
      ...
      latest: "En son",
      latest_hint_empty: "TchuEkaM'i daha çok çalıştır",
      none_yet: "Henüz yok",
    },
    state: {
      unlocked: "Açıldı",
    ...
    guide: {
      ...
      secret_body:
        "Sırlar, tetikleyicilerini saklı tutar. TchuEkaM ilgili bir sinyal gördüğünde kart Keşfedildi durumuna geçer ve gereksinimini gösterir.",
      scan_status_header: "Tarama durumu",
      scan_status_body:
        "TchuEkaM yerel geçmişi bir kez tarıyor; sonra kartlar otomatik olarak görünür. Birkaç saniye sürmesi normaldir, hiçbir şey takılmadı.",
