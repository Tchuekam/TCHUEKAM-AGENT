...
export const de: Translations = {
  ...
  status: {
    ...
    stopped: "Gestoppt",
    updateTchuEkaM: "TchuEkaM aktualisieren",
    updatingTchuEkaM: "TchuEkaM wird aktualisiert…",
  ...
  pluginsPage: {
    ...
    headline:
      "TchuEkaM-Plugins entdecken, installieren, aktivieren und aktualisieren (entspricht `tchuekam plugins`).",
    ...
    removeConfirm: "Dieses Plugin aus ~/.tchuekam/plugins/ entfernen?",
    removeHint: "Nur vom Benutzer installierte Plugins unter ~/.tchuekam/plugins können entfernt werden.",
  ...
  skills: {
    ...
    filters: "Filter",
    noSkills: "Keine Skills gefunden. Skills werden aus ~/.tchuekam/skills/ geladen",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Sammelbare TchuEkaM-Abzeichen, verdient durch echten Sitzungsverlauf. Bekannte, noch nicht abgeschlossene Achievements werden als Entdeckt angezeigt; geheime Achievements bleiben verborgen, bis das erste passende Verhalten auftritt.",
      scan_subtitle:
        "TchuEkaM-Sitzungsverlauf wird gescannt. Der erste Scan kann bei umfangreichem Verlauf 5–10 Sekunden dauern.",
    },
    actions: {
      rescan: "Neu scannen",
    },
    stats: {
      ...
      latest: "Neueste",
      latest_hint_empty: "nutze TchuEkaM mehr",
      none_yet: "Noch keine",
    },
    state: {
      unlocked: "Freigeschaltet",
    ...
    guide: {
      ...
      secret_body:
        "Geheimnisse verbergen ihren genauen Auslöser. Sobald TchuEkaM ein verwandtes Signal erkennt, wird die Karte zu Entdeckt und zeigt ihre Anforderung an.",
      scan_status_header: "Scan-Status",
      scan_status_body:
        "TchuEkaM scannt den lokalen Verlauf einmalig, danach erscheinen die Karten automatisch. Es ist nichts hängengeblieben, wenn dies ein paar Sekunden dauert.",
