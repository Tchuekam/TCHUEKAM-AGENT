...
export const fr: Translations = {
  ...
  status: {
    ...
    stopped: "Arrêté",
    updateTchuEkaM: "Mettre à jour TchuEkaM",
    updatingTchuEkaM: "Mise à jour de TchuEkaM…",
  ...
  pluginsPage: {
    ...
    headline:
      "Découvrez, installez, activez et mettez à jour les plugins TchuEkaM (parité avec `tchuekam plugins`).",
    ...
    removeConfirm: "Retirer ce plugin de ~/.tchuekam/plugins/ ?",
    removeHint: "Seuls les plugins installés par l'utilisateur sous ~/.tchuekam/plugins peuvent être supprimés.",
  ...
  skills: {
    ...
    filters: "Filtres",
    noSkills: "Aucune compétence trouvée. Les compétences sont chargées depuis ~/.tchuekam/skills/",
  ...
  config: {
    configPath: "~/.tchuekam/config.yaml",
    filters: "Filtres",
    sections: "Sections",
  ...
  achievements: {
    hero: {
      ...
      title: "TchuEkaM Achievements",
      subtitle:
        "Badges TchuEkaM à collectionner, gagnés à partir de l'historique réel des sessions. Les succès connus non terminés sont affichés comme Découverts ; les succès secrets restent cachés jusqu'à l'apparition du premier comportement correspondant.",
      scan_subtitle:
        "Analyse de l'historique des sessions TchuEkaM en cours. Le premier scan peut prendre 5 à 10 secondes sur les historiques volumineux.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Dernier",
      latest_hint_empty: "utilisez TchuEkaM davantage",
    ...
    guide: {
      ...
      secret_body:
        "Les secrets cachent leur déclencheur exact. Dès qu'TchuEkaM détecte un signal lié, la carte passe à Découvert et affiche son exigence.",
      scan_status_header: "État du scan",
      scan_status_body:
        "TchuEkaM analyse l'historique local une seule fois, puis les cartes apparaîtront automatiquement. Rien n'est bloqué si cela prend quelques secondes.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in TchuEkaM Agent ☤",
    },
  },
  kanban: {
