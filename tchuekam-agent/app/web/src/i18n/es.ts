...
export const es: Translations = {
  ...
  status: {
    ...
    stopped: "Detenido",
    updateTchuEkaM: "Actualizar TchuEkaM",
    updatingTchuEkaM: "Actualizando TchuEkaM…",
  ...
  pluginsPage: {
    ...
    headline:
      "Descubre, instala, habilita y actualiza complementos de TchuEkaM (equivalente a `tchuekam plugins`).",
    ...
    removeConfirm: "¿Eliminar este complemento de ~/.tchuekam/plugins/?",
    removeHint: "Solo se pueden eliminar complementos instalados por el usuario en ~/.tchuekam/plugins.",
  ...
  skills: {
    ...
    filters: "Filtros",
    noSkills: "No se encontraron habilidades. Las habilidades se cargan desde ~/.tchuekam/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Insignias coleccionables de TchuEkaM ganadas a partir del historial real de sesiones. Los logros conocidos no completados se muestran como Descubiertos; los logros secretos permanecen ocultos hasta que aparece el primer comportamiento coincidente.",
      scan_subtitle:
        "Escaneando el historial de sesiones de TchuEkaM. El primer escaneo puede tardar 5–10 segundos en historiales grandes.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Más reciente",
      latest_hint_empty: "usa TchuEkaM más",
    ...
    guide: {
      ...
      secret_body:
        "Los secretos ocultan su disparador exacto. Una vez que TchuEkaM detecta una señal relacionada, la tarjeta pasa a Descubierto y muestra su requisito.",
      scan_status_header: "Estado del escaneo",
      scan_status_body:
        "TchuEkaM está escaneando el historial local una vez, después las tarjetas aparecerán automáticamente. No hay nada bloqueado si tarda unos segundos.",
