 ...
 * `window.__TCHUEKAM_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the TchuEkaM brand in the top bar
 ...
 *  `window.__TCHUEKAM_PLUGINS__.registerSlot(...)`.
 *
