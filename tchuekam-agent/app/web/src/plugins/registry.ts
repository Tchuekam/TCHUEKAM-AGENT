 ...
 *
 * Plugins call window.__TCHUEKAM_PLUGINS__.register(name, Component)
...
declare global {
  interface Window {
    __TCHUEKAM_PLUGIN_SDK__: unknown;
    __TCHUEKAM_PLUGINS__: {
...
export function exposePluginSDK() {
  window.__TCHUEKAM_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__TCHUEKAM_PLUGIN_SDK__ = {
