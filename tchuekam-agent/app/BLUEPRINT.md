...
This document defines the architectural specification, operational pillars, and development blueprint for the **Sovereign Engine** (rebranded, enterprise-packaged edition of the TchuEkaM Agent).
...
### 3. TECHNICAL STACK
The Sovereign Engine is built directly on top of the **TchuEkaM Agent** local runtime:
...
We extend the existing **TchuEkaM Agent** codebase located at `D:\tchuekam-agent\app`:
