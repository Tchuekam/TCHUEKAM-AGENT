...
Built for [TchuEkaM Agent](https://github.com/NousResearch/tchuekam-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/tchuekam-agent/skills/creative/ascii-video`](https://github.com/NousResearch/tchuekam-agent/tree/main/skills/creative/ascii-video) via PR.
