#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the TchuEkaM docs site.
...
Both publish at:
  https://tchuekam-agent.nousresearch.com/docs/llms.txt
  https://tchuekam-agent.nousresearch.com/docs/llms-full.txt
...
SITE_BASE = "https://tchuekam-agent.nousresearch.com/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use TchuEkaM as a Python Library", None),
        ("guides/use-mcp-with-tchuekam", "Use MCP with TchuEkaM", None),
        ("guides/use-voice-mode-with-tchuekam", "Use Voice Mode with TchuEkaM", None),
        ("guides/use-soul-with-tchuekam", "Use SOUL.md with TchuEkaM", None),
        ("guides/build-a-tchuekam-plugin", "Build a TchuEkaM Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with TchuEkaM"),
...
def emit_llms_index() -> str:
    ...
    lines.append(
        ...
        "tchuekam-agent/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/NousResearch/tchuekam-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# TchuEkaM Agent — Full Documentation\n",
        (
            "This file is the entire TchuEkaM Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using TchuEkaM, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://tchuekam-agent.nousresearch.com/docs\n",
        "Short index: https://tchuekam-agent.nousresearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
