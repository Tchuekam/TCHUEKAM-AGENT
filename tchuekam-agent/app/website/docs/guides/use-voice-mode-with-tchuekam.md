---
sidebar_position: 8
title: "Use Voice Mode with TchuEkaM"
description: "A practical guide to setting up and using TchuEkaM voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with TchuEkaM
...
- you want TchuEkaM sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in TchuEkaM.
...
## Step 1: make sure normal TchuEkaM works first
...
TchuEkaM supports both local and cloud speech stacks.
...
4. TchuEkaM transcribes and responds
...
- asking TchuEkaM to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full TchuEkaM loop.

## Tuning CLI behavior

### Silence threshold

If TchuEkaM starts/stops too aggressively, tune:
...
TchuEkaM stays a normal chat bot, but can speak replies.
...
- you want TchuEkaM to function like a portable research or ops assistant
...
TchuEkaM joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- TchuEkaM detects speech boundaries
- transcripts are posted in the associated text channel
- TchuEkaM responds in text and audio
...
1. get text TchuEkaM working
2. install `tchuekam-agent[voice]`
