...
| | |
|---|---|
| Source | Optional — install with `tchuekam skills install official/blockchain/evm` |
| Path | `optional-skills/blockchain/evm` |
| Version | `1.0.0` |
| Author | Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), TchuEkaM Agent |
| License | MIT |
...
Helper script path: `~/.tchuekam/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.tchuekam/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.tchuekam/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.tchuekam/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
