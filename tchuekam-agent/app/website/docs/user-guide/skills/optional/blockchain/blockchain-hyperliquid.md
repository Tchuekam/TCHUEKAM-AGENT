...
| | |
|---|---|
| Source | Optional — install with `tchuekam skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), TchuEkaM Agent |
| License | MIT |
...
The script reads `~/.tchuekam/.env` for two optional defaults:
...
Helper script: `~/.tchuekam/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.tchuekam/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.tchuekam/.env`.
...
```bash
python3 ~/.tchuekam/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.tchuekam/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
