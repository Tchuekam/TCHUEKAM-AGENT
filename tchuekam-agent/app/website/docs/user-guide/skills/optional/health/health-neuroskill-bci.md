...
| | |
|---|---|
| Source | Optional — install with `tchuekam skills install official/health/neuroskill-bci` |
...
Connect TchuEkaM to a running [NeuroSkill](https://neuroskill.com/) instance to read
