...
| | |
|---|---|
| Source | Optional — install with `tchuekam skills install official/research/qmd` |
...
TchuEkaM Agent via the native MCP client. This is the preferred
...
Then configure TchuEkaM Agent to connect via HTTP:
