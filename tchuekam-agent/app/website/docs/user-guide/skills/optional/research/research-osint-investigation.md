...
| | |
|---|---|
| Source | Optional — install with `tchuekam skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | TchuEkaM Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $TCHUEKAM_OSINT_CACHE/icij/ (default: ~/.cache/tchuekam-osint/icij/).
...
# Set TCHUEKAM_OSINT_UA=your-app/1.0 (your@email) to identify yourself
