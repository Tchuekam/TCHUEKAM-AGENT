...
| | |
|---|---|
| Source | Optional — install with `tchuekam skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), TchuEkaM Agent |
| License | MIT |
...
```
SCRIPT=~/.tchuekam/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.tchuekam/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
