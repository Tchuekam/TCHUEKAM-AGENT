...
```bash
python3 -m pyfiglet "TCHUEKAM" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=TCHUEKAM&font=Slant" | boxes -d stone
```
