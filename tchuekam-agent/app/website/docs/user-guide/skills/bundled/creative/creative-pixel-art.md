...
```python
import sys
sys.path.insert(0, "/home/teknium/.tchuekam/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.tchuekam/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — TchuEkaM installs package this)
