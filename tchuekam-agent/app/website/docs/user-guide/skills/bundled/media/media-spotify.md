...
Control the user's Spotify account via the TchuEkaM Spotify toolset (7 tools). Setup guide: https://tchuekam-agent.nousresearch.com/docs/user-guide/features/spotify
...
**`401 Unauthorized` after a retry** — refresh token revoked. Tell the user to run `tchuekam auth spotify` again.
