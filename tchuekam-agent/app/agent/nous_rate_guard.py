...
(3 SDK retries x 3 TchuEkaM retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = get_tchuekam_home()
    except ImportError:
        base = os.path.join(os.path.expanduser("~"), ".tchuekam")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, TchuEkaM, ...) behind one endpoint.  A 429 can mean either:
