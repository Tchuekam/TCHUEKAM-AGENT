...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - tchuekam_home (str): The active TCHUEKAM_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.tchuekam``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "tchuekam").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'tchuekam memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], tchuekam_home: str) -> None:
        """Write non-secret config to the provider's native location.

        Called by 'tchuekam memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``tchuekam_home`` is the active TCHUEKAM_HOME directory path.
