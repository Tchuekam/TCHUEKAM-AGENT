#!/usr/bin/env python3
"""Build the TchuEkaM Model Catalog — a centralized JSON manifest of curated models.
...
TchuEkaM CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a TchuEkaM release.
...
# Ensure TCHUEKAM_HOME is set for imports that touch it at module level.
os.environ.setdefault("TCHUEKAM_HOME", os.path.join(os.path.expanduser("~"), ".tchuekam"))

from tchuekam_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "tchuekam-agent repo",
            "docs": "https://tchuekam-agent.nousresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
