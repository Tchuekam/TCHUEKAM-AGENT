...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^TchuEkaM\s+(Agent|Audit)$", re.IGNORECASE),
...
IGNORED_EMAILS = {
    ...
    "tchuekam@nousresearch.com",
    "tchuekam-audit@example.com",
    "tchuekam@habibilabs.dev",
}
...
def gh_pr_list():
    ...
    try:
        result = subprocess.run(
            [
                "gh", "pr", "list",
                "--repo", "NousResearch/tchuekam-agent",
                "--state", "merged",
