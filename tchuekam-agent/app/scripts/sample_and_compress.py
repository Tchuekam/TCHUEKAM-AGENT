...
DEFAULT_DATASETS = [
    ...
    "NousResearch/tchuekam-agent-megascience-sft1",
    "NousResearch/TchuEkaM-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/TchuEkaM-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-tchuekam-agent"
]
