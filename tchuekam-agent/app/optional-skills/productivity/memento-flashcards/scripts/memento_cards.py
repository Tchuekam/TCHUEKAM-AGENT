...
Data file: $TCHUEKAM_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_TCHUEKAM_HOME = Path(os.environ.get("TCHUEKAM_HOME", Path.home() / ".tchuekam"))
DATA_DIR = _TCHUEKAM_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
