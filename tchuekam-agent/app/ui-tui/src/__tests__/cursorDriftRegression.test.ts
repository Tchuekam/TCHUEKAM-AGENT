 ...
 *
 * Symptom: in `tchuekam --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@tchuekam/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using tchuekam --tui and as i type multiline my caret at the end will often ' +
