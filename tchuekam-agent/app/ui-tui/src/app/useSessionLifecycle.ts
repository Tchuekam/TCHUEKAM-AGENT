...
import type { ScrollBoxHandle } from '@tchuekam/ink'
import { evictInkCaches } from '@tchuekam/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.TCHUEKAM_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
