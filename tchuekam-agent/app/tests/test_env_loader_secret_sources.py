"""Tests for the secret-source tracking in ``tchuekam_cli.env_loader``.

These cover the small public surface that lets `tchuekam model` / `tchuekam setup`
...
from tchuekam_cli import env_loader  # noqa: E402
