...
def _enable_managed_nous_tools(monkeypatch):
    ...
    tchuekam_cli.auth and tchuekam_cli.models — so the function body returns True.
    """
    monkeypatch.setattr("tchuekam_cli.auth.get_nous_auth_status", lambda: {"logged_in": True})
    monkeypatch.setattr("tchuekam_cli.models.check_nous_free_tier", lambda: False)
