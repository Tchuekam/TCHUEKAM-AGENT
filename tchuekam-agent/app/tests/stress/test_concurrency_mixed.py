...
def worker_loop(worker_id: int, tchuekam_home: str, result_file: str) -> None:
...
def reclaimer_loop(tchuekam_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="tchuekam_mixed_stress_")
    print(f"TCHUEKAM_HOME = {home}")
