...
def test_load_transcript_returns_db_messages_when_no_jsonl(tmp_path, monkeypatch):
    ...
    ~/.tchuekam/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at tchuekam_state import time, before pytest's TCHUEKAM_HOME monkeypatch
    fires — the autouse fixture's TCHUEKAM_HOME override doesn't help here.)
    """
