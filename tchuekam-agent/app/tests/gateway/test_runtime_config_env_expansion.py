...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("TCHUEKAM_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("TCHUEKAM_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    ...
    monkeypatch.delenv("TCHUEKAM_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path
