"""Tests for CodexEventProjector — codex item/* events → TchuEkaM messages list.
...
class TestRoleAlternationInvariant:
    ...
    one item — that breaks TchuEkaM' message alternation invariant."""
