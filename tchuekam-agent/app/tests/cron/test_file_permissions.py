...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("tchuekam_cli.config.get_config_path", return_value=config_path), \
             patch("tchuekam_cli.config.ensure_tchuekam_home"):
    ...
    def test_ensure_tchuekam_home_sets_0700(self):
        home = Path(self.tmpdir) / ".tchuekam"
        with patch("tchuekam_cli.config.get_tchuekam_home", return_value=home):
