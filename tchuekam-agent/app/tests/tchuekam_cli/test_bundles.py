"""Tests for tchuekam_cli/bundles.py — the `tchuekam bundles` CLI subcommand."""
...
from tchuekam_cli.bundles import (
    bundles_command,
    register_cli,
)
...
def bundles_env(tmp_path, monkeypatch):
    ...
    monkeypatch.setenv("TCHUEKAM_BUNDLES_DIR", str(bundles_dir))
