...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from tchuekam_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in TCHUEKAM_OVERLAYS
        overlay = TCHUEKAM_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify tchuekam doctor recognizes Xiaomi env vars."""
