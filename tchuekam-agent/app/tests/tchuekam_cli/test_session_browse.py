"""Tests for the interactive session browser (`tchuekam sessions browse`).
...
from tchuekam_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """tchuekam sessions browse should be parseable."""
        from tchuekam_cli.main import main as _main_entry
