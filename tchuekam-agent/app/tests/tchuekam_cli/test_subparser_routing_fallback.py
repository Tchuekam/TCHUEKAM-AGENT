...
The main() function in tchuekam_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `tchuekam -c model`
...
def _build_parser():
    """Build a minimal replica of the tchuekam top-level parser."""
