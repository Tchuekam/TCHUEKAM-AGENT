...
* **Protect the Core Loop**: Do not refactor or modify core execution files (`run_agent.py`, `cli.py`, `hermes_state.py`) unless a capability specifically requires modifying the base agent loop.
